...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        picture_left_back = (ImageView) findViewById(R.id.preview_picture_left_back);
        viewPager = (PreviewViewPager) findViewById(R.id.preview_pager);
        ll_check = (RelativeLayout) findViewById(R.id.ll_check);
        id_ll_ok = (LinearLayout) findViewById(R.id.title_ll_ok);
        check = (TextView) findViewById(R.id.check);
        picture_left_back.setOnClickListener(this);
        tv_ok = (TextView) findViewById(R.id.picture_tv_ok);
        id_ll_ok.setOnClickListener(this);
        tv_img_num = (TextView) findViewById(R.id.picture_tv_img_num);
        tv_title = (TextView) findViewById(R.id.preview_title_center);
        ...
        if(numComplete){
            tv_ok.setBackgroundDrawable(ContextCompat.getDrawable(this,R.drawable.unselect_picture));
            tv_ok.setTextColor(getResources().getColor(R.color.unselect_title_right_text_color));
        }
    ...
    public void onSelectNumChange(boolean isRefresh) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                tv_ok.setBackgroundDrawable(ContextCompat.getDrawable(this,R.drawable.select_picture));
                tv_ok.setTextColor(getResources().getColor(R.color.title_right_text_color));
            } else {
                if (refresh) {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.preview_picture_left_back) {
            onBackPressed();
        }
        if (id == R.id.title_ll_ok) {
