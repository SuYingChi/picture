...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config.camera) {
            ...
            setContentView(R.layout.my_picture_selector_layout);
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        picture_title = (TextView) findViewById(R.id.picture_preview_title_center);
    ...
    private void isNumComplete(boolean numComplete) {
        ...
        if(numComplete){
            picture_tv_ok.setBackgroundDrawable(ContextCompat.getDrawable(this,R.drawable.unselect_picture));
            picture_tv_ok.setTextColor(getResources().getColor(R.color.unselect_title_right_text_color));
        }
        if (!numComplete) {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.picture_preview_title_center) {
            if (folderWindow.isShowing()) {
                folderWindow.dismiss();
            } else {
                if (images != null && images.size() > 0) {
                    //folderWindow.showAsDropDown(rl_picture_title);
                    folderWindow.showUp(rl_picture_title,rl_bottom);
                    List<LocalMedia> selectedImages = adapter.getSelectedImages();
    ...
    public void changeImageNumber(List<LocalMedia> selectImages) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                picture_tv_ok.setBackgroundDrawable(ContextCompat.getDrawable(this,R.drawable.select_picture));
                picture_tv_ok.setTextColor(getResources().getColor(R.color.title_right_text_color));
            } else {
                if (!anim) {
